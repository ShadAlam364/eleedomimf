...
import ClaimUpdate from "./ClaimUpdate.jsx";
...
function ViewClaimed() {
  ...
  const onUpdateClaims = async () => {
    try {
      ...
      console.error("Error fetching updated claims data");
    }
  };
        ...
        <div className="container-fluid flex justify-center px-1  border-gray-200 border-dashed rounded-lg dark:border-gray-700  bg-slate-100">
          ...
          <div className="inline-block min-w-full mt-2">
            <div className="my-2 flex justify-between text-blue-500">
              <h1></h1>
              <h1 className="text-2xl my-auto font-semibold text-blue-700 uppercase">
                Claim Lists
              </h1>
              <span className="flex justify-end ">
                <button className="" onClick={handleExportClick}>
                  <img src="/excel.png" alt="download" className="w-10 mr-2" />
                </button>
                {/* <NavLink to="/cic/home/claim" className="my-auto text-red-700">
            ...
            <div className="my-2 flex flex-wrap justify-between text-blue-700">
              <div className="flex flex-col  p-2 text-start sm:w-44 lg:w-44 w-1/3">
                <label
                  ...
                  className="text-base font-medium mx-1 "
                >
                  PE-Date:
                </label>
                <input
              ...
              <div className="flex flex-col  p-2 text-start sm:w-44 lg:w-44 w-1/3">
                ...
                <input
                  ...
                  type="search"
                  name="surveyorName"
                  onChange={(e) => setSurvy(e.target.value)}
              ...
              <div className="flex flex-col  p-2 text-start sm:w-44 lg:w-44 w-1/3">
                ...
                <input
                  ...
                  type="search"
                  name="advisor"
                  onChange={(e) => setAdvs(e.target.value)}
              ...
              <div className="flex flex-col  p-2 text-start sm:w-44 lg:w-44 w-1/3">
                <label htmlFor="branch" className="text-base font-medium mx-1 ">
                  Branch:
                </label>
                <input
                  id="branch"
                          ...
                          >
                            <td className="whitespace-nowrap px-1 border border-black">
                              <button
                                ...
                                type="button"
                                className="text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-0 focus:outline-none focus:ring-blue-300 shadow-lg shadow-blue-500/50 font-medium rounded text-sm px-2 py-1 my-0.5 mx-0.5 text-center"
                              >
                                Update
                              </button>
                            </td>
                            ...
                            <td className="whitespace-nowrap px-1 border border-black">
                              <button
                                ...
                                className="text-white bg-gradient-to-r from-red-600 via-red-600 to-red-600 hover:bg-red-700 focus:ring-1 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 shadow-lg shadow-red-500/50 dark:shadow-lg dark:shadow-red-800/80 font-medium rounded text-sm px-2 py-1 text-center my-1"
                              >
                                Delete
                              </button>
                            </td>
            ...
            <div className="bg-white p-4 rounded-lg ">
              <h2 className="text-lg font-semibold text-gray-800">
                ...
                <span className="text-red-600">
                  {
                    filteredData.find((data) => data._id === deletingStaffId)
                      ?.insuredName
                  }
                </span>
                {`?`}
              ...
              <div className="flex justify-end mt-10">
                <button
                  onClick={() => {
                    deleteClaims(deletingStaffId);
                    setDeletingStaffId(null);
                  }}
                  className="text-white bg-red-600 hover:bg-red-800 focus:ring-0 focus:outline-none focus:ring-red-300  font-medium rounded text-sm px-2 py-1 mr-2"
                >
                  Yes, I&apos;m sure
                </button>
                <button
                  onClick={() => setDeletingStaffId(null)}
                  className="text-gray-100 bg-slate-400 hover:bg-gray-400 focus:ring-1 focus:outline-none focus:ring-gray-500 rounded border border-gray-800 text-sm font-medium px-2 py-1 hover:text-gray-900 focus:z-10 "
                >
                  No, cancel
                </button>
              </div>
