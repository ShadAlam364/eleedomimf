...
import CancelUpdate from './CancelUpdate.jsx';
import VITE_DATA from '../../../config/config.jsx';
import TextLoader from '../../../loader/TextLoader.jsx';

function ViewCancelation() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const response = await axios.get(`${VITE_DATA}/cancled/view`, {
          headers: {
            Authorization: `${token}`,
          },
        });
  ...
  const onUpdateCancel = async () => {
    try {
      ...
      console.error("Error fetching updated Cancelation Data");
    }
  };
...
export default ViewCancelation;