  ...
  return (
    <section className="fixed rounded backdrop-blur-lg top-0 right-0  left-0 bottom-0 inset-0 z-50 overflow-y-auto overflow-x-hidden bg-black bg-opacity-50">
      <div className="relative bg-transparent p-1 xl:w-10/12 lg:w-10/12 md:w-10/12 sm:w-10/12 w-11/12 max-w-4xl max-h-7xl mx-auto xl:my-40 lg:my-40 md:my-30 sm:my-10 my-10 rounded">
        ...
        <main className="z-100 container-fluid flex justify-center p-0.5  rounded  bg-gradient-to-l  from-red-500 via-slate-300 to-red-700">
          <div className="relative w-full  rounded shadow-xl text-2xl items-center bg-gradient-to-r  from-red-600 via-red-500 to-red-600">
            <div className="flex flex-wrap py-5 justify-evenly">
              <div className="h-52 w-52">
                <img src="/bik.png" alt="fourwheeler" />
              </div>
              ...
              <div className="flex  flex-col justify-evenly mb-5 xl:mb-0 lg:mb-0 md:mb-0 sm:mb-5 text-center ">
                ...
                <button
                  className={`relative py-auto inline-flex items-center justify-center p-0.5 overflow-hidden text-sm font-medium text-gray-900 rounded-md group ${!vehicleNo ? 'cursor-not-allowed opacity-50 bg-red-800' : 'bg-red-600 hover:bg-red-800 hover:-translate-y-1 duration-300 hover:text-white'}`}
                  disabled={!vehicleNo}
                >
