                ...
                >
                  <div>
                    ...
                    <input
                      ...
                      className="bg-gray-200 border border-gray-200 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 active:placeholderbg-gray-400 focus:border-primary-500 block w-full p-2.5"
