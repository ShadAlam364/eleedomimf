...
function NotFound() {
  ...
  const handleGoBack = () => {
    navigate(-1); // Moves back in the application's routing history
  };
  return (
    <AnimatePresence>
      <div className="bg-slate-200">
        ...
        >
          <div className="w-full lg:w-1/2 flex flex-col items-center justify-center lg:px-2 xl:px-0 text-center">
            <p className="text-7xl md:text-8xl lg:text-9xl font-bold tracking-wider text-transparent bg-gradient-to-r bg-clip-text from-slate-600 to-green-600">
              404
            </p>
            <p className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-wider text-transparent bg-gradient-to-r bg-clip-text from-slate-600 to-green-600">
              Page Not Found
            </p>
            <p className="text-lg md:text-xl lg:text-2xl text-gray-500 py-12 tracking-wider font-semibold">
              Sorry, the page you are looking for could not be found.
            </p>
            <button
              onClick={handleGoBack}
              className="flex items-center space-x-2 bg-blue-600 hover:bg-blue-700 text-gray-100 px-4 py-2 tracking-wider font-semibold rounded transition duration-150"
            >
              <span>Return Home</span>
            </button>
          </div>
          <div className="w-1/2 lg:h-2/3 flex lg:items-end justify-center p-4">
            <svg
            ...
            >
              ...
              <circle cx="212.59226" cy="103" r="64" fill="#FF1500"></circle>
              <path
