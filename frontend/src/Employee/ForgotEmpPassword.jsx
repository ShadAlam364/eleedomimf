...
function ForgotEmpPassword() {
  ...
  const handleSubmit = async (e) => {
    ...
    return (
        <>
        <section className="container-fluid h-screen relative bg-blue-500">
          <div className="container-fluid pt-5 flex flex-col md:flex-row items-center  justify-between bg-blue-500">
                ...
                >
                  <div>
                    ...
                    <input
                      ...
                      autoComplete="email"
                      className="bg-gray-200 border border-gray-200 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 active:placeholderbg-gray-400focus:border-primary-500 block w-full p-2.5"
